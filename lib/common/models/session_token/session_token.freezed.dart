...
abstract class $SessionTokenCopyWith<$Res> {
  factory $SessionTokenCopyWith(
    SessionToken value,
    $Res Function(SessionToken) then,
...
class _$SessionTokenCopyWithImpl<$Res, $Val extends SessionToken>
  ...
  @override
  $Res call({Object? id = freezed, Object? token = freezed}) {
    return _then(
      _value.copyWith(
            id:
                freezed == id
...
class _$SessionTokenImpl extends _SessionToken {
  const _$SessionTokenImpl({this.id, this.token}) : super._();
  ...
  @override
  String toString() {
    return 'SessionToken(id: $id, token: $token)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$SessionTokenImplToJson(this);
  }
}

abstract class _SessionToken extends SessionToken {
  const factory _SessionToken({final int? id, final String? token}) =
      _$SessionTokenImpl;
